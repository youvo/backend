 ...
 *
 * @todo This is more or less a copy of TextProcessedFieldItemList. This should
 *   be delegated to theming.
 */
class TextMarkupFieldItemList extends FieldItemList implements FieldItemListInterface {
