...
class QuestionSubmissionResource extends ResourceBase {
   ...
   *
   * @param \Drupal\questionnaire\Entity\Questionnaire $questionnaire
   ...
   *   Response.
   */
  public function post(Questionnaire $questionnaire, Request $request) {
  ...
  public function routes() {
    ...
    foreach ($methods as $method) {
      ...
      $route->setRequirement('_custom_access', '\Drupal\questionnaire\Controller\QuestionnaireAccessController::accessQuestionnaire');
